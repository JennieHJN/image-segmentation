...
def window_partition(x, window_size):
    ...
    # view: [B, H//Mh, W//Mw, Mh, Mw, C] -> [B*num_windows, Mh, Mw, C]num_windows=(H//Mh)*(W//Mw)
...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        trunc_normal_(self.relative_position_bias_table, std=.02)   #relative_position_bias_table
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shift_size=0,
        ...
        if self.shift_size > 0:  #shift_size=window_size//2
...
class SwinUnetnat_lcab_three(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
                 ...
                 linear=False, depths_s=[4, 4, 4],dimse=[192,384,768],
